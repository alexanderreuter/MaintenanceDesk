        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UnitId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ReportedByResidentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MaintenanceRequests_Residents_ReportedByResidentId",
                        column: x => x.ReportedByResidentId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceRequests_ReportedByResidentId",
                table: "MaintenanceRequests",
                column: "ReportedByResidentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Units_PropertyId_Designation",
                table: "Units",
                columns: new[] { "PropertyId", "Designation" },
                unique: true);
        }
